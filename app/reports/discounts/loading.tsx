...
export default function DiscountsReportLoading() {
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <div className="h-8 w-44 rounded-md bg-muted/60 animate-pulse" />
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-wrap items-end gap-4">
            ...
            <div className="h-10 w-24 rounded-md bg-muted/40 animate-pulse" />
          </div>
        </CardContent>
      </Card>
